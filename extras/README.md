...
1. [Analysis on local scratch space on worker nodes](extras/tmpdir-usage.md)

2. [Analysis with containers](extras/singularity-usage.md)

3. [Accessing data from external storage systems](master/extras/macaroons-usage.md)
