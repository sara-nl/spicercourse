...
In this section you will run the same E. coli analysis example but by importing software from a singularity  container. Let us first inspect what version of singularity is available on the system
